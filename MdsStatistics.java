...
public class MdsStatistics implements Statistics, LongTask {
    ...
    public void execute(Graph hgraph, AttributeModel attributeModel) {
        ...
        AttributeColumn col3 = nodeTable.getColumn(DIM_3);
        AttributeColumn col4 = nodeTable.getColumn(DIM_4);
        AttributeColumn col5 = nodeTable.getColumn(DIM_5);
        AttributeColumn col6 = nodeTable.getColumn(DIM_6);
        AttributeColumn col7 = nodeTable.getColumn(DIM_7);
        AttributeColumn col8 = nodeTable.getColumn(DIM_8);
        AttributeColumn col9 = nodeTable.getColumn(DIM_9);
        AttributeColumn col10 = nodeTable.getColumn(DIM_10);
        ...
        if (numberDimensions == 2) {
            ...
            if(col3 == null) {
                col3 = nodeTable.addColumn(DIM_3, "Dimension_3", AttributeType.DOUBLE, AttributeOrigin.COMPUTED, 0.0);
            }
            if(col4 != null) {
                nodeTable.removeColumn(col4);
                col4 = null;
            ...
            if(col4 == null) {
                col4 = nodeTable.addColumn(DIM_4, "Dimension_4", AttributeType.DOUBLE, AttributeOrigin.COMPUTED, 0.0);
            }
            if(col5 != null) {
                nodeTable.removeColumn(col5);
                col5 = null;
            ...
            if(col5 == null) {
                col5 = nodeTable.addColumn(DIM_5, "Dimension_5", AttributeType.DOUBLE, AttributeOrigin.COMPUTED, 0.0);
            }
            if(col6 != null) {
                nodeTable.removeColumn(col6);
                col6 = null;
            ...
            if(col6 == null) {
                col6 = nodeTable.addColumn(DIM_6, "Dimension_6", AttributeType.DOUBLE, AttributeOrigin.COMPUTED, 0.0);
            }
            if(col7 != null) {
                nodeTable.removeColumn(col7);
                col7 = null;
            ...
            if(col7 == null) {
                col7 = nodeTable.addColumn(DIM_7, "Dimension_7", AttributeType.DOUBLE, AttributeOrigin.COMPUTED, 0.0);
            }
            if(col8 != null) {
                nodeTable.removeColumn(col8);
                col8 = null;
            ...
            if(col8 == null) {
                col8 = nodeTable.addColumn(DIM_8, "Dimension_8", AttributeType.DOUBLE, AttributeOrigin.COMPUTED, 0.0);
            }
            if(col9 != null) {
                nodeTable.removeColumn(col9);
                col9 = null;
            ...
            if(col9 == null) {
                col9 = nodeTable.addColumn(DIM_9, "Dimension_9", AttributeType.DOUBLE, AttributeOrigin.COMPUTED, 0.0);
            }
            if(col10 != null) {
                nodeTable.removeColumn(col10);
                col10 = null;
           ...
           if(col5 == null) {
            ...
            if(col10 == null) {
                col10 = nodeTable.addColumn(DIM_10, "Dimension_10", AttributeType.DOUBLE, AttributeOrigin.COMPUTED, 0.0);
            }
        }
        ...
        for (Node n : hgraph.getNodes()) {
            ...
            if (numberDimensions == 2) {
                ...
                n.getAttributes().setValue(col2.getIndex(), output[1][n_index]);
                    ...
                    n.getAttributes().setValue(col1.getIndex(), output[0][n_index]);
                    n.getAttributes().setValue(col2.getIndex(), output[1][n_index]);
                    n.getAttributes().setValue(col3.getIndex(), output[2][n_index]);
            } else if (numberDimensions == 4) {
                    n.getAttributes().setValue(col1.getIndex(), output[0][n_index]);
                    n.getAttributes().setValue(col2.getIndex(), output[1][n_index]);
                    n.getAttributes().setValue(col3.getIndex(), output[2][n_index]);
                    n.getAttributes().setValue(col4.getIndex(), output[3][n_index]);
            } else if (numberDimensions == 5) {
                    n.getAttributes().setValue(col1.getIndex(), output[0][n_index]);
                    n.getAttributes().setValue(col2.getIndex(), output[1][n_index]);
                    n.getAttributes().setValue(col3.getIndex(), output[2][n_index]);
                    n.getAttributes().setValue(col4.getIndex(), output[3][n_index]);
                    n.getAttributes().setValue(col5.getIndex(), output[4][n_index]);
            }  else if (numberDimensions == 6) {
                    n.getAttributes().setValue(col1.getIndex(), output[0][n_index]);
                    n.getAttributes().setValue(col2.getIndex(), output[1][n_index]);
                    n.getAttributes().setValue(col3.getIndex(), output[2][n_index]);
                    ...
                    n.getAttributes().setValue(col4.getIndex(), output[3][n_index]);
                    n.getAttributes().setValue(col5.getIndex(), output[4][n_index]);
                    n.getAttributes().setValue(col6.getIndex(), output[5][n_index]);
                    n.getAttributes().setValue(col7.getIndex(), output[6][n_index]);
            }  else if (numberDimensions == 8) {
                    n.getAttributes().setValue(col1.getIndex(), output[0][n_index]);
                    n.getAttributes().setValue(col2.getIndex(), output[1][n_index]);
                    n.getAttributes().setValue(col3.getIndex(), output[2][n_index]);
                    ...
                    n.getAttributes().setValue(col6.getIndex(), output[5][n_index]);
                    n.getAttributes().setValue(col7.getIndex(), output[6][n_index]);
                    n.getAttributes().setValue(col8.getIndex(), output[7][n_index]);
            }  else if (numberDimensions == 9) {
                    n.getAttributes().setValue(col1.getIndex(), output[0][n_index]);
                    n.getAttributes().setValue(col2.getIndex(), output[1][n_index]);
                    n.getAttributes().setValue(col3.getIndex(), output[2][n_index]);
                    ...
                    n.getAttributes().setValue(col7.getIndex(), output[6][n_index]);
                    n.getAttributes().setValue(col8.getIndex(), output[7][n_index]);
                    n.getAttributes().setValue(col9.getIndex(), output[8][n_index]);
            }  else if (numberDimensions == 10) {
                    n.getAttributes().setValue(col1.getIndex(), output[0][n_index]);
                    n.getAttributes().setValue(col2.getIndex(), output[1][n_index]);
                    n.getAttributes().setValue(col3.getIndex(), output[2][n_index]);
                    ...
                    n.getAttributes().setValue(col8.getIndex(), output[7][n_index]);
                    n.getAttributes().setValue(col9.getIndex(), output[8][n_index]);
                    n.getAttributes().setValue(col10.getIndex(), output[9][n_index]);
            }
        }
        hgraph.readUnlock();
    }
